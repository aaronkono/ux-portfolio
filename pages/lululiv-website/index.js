...
export default function FixPlatformManage() {
            ...
            <header className="d-flex flex-row h-100">
              <div className="ak--container d-flex align-items-center justify-content-center flex-column w-50">
                <div className="header-subpage-main-text">
                  ...
                  Create a presence for Lululiv and it's offering of property management
                  as a service to Principals around Australia
                  </p>
              ...
              <div className="d-flex position-relative align-items-center justify-content-center w-50 ak--profile-image">
                <img src="./static/lululiv-website-header.jpg" className="w-100" />
  ...
  <path fill="#CDEBF9" d="M31.9,-34.9C38.1,-17.8,37.4,-4.7,37.5,14C37.6,32.6,38.3,56.8,29.1,61.9C19.8,67,0.6,52.9,-20.4,42.6C-41.3,32.4,-64,26.1,-72,10.8C-80,-4.5,-73.3,-28.8,-58.9,-47.8C-44.4,-66.8,-22.2,-80.5,-4.7,-76.8C12.9,-73.1,25.8,-52,31.9,-34.9Z" transform="translate(100 100)" />
              ...
              <div className="processProblemContainerOuter">
                <div className="processProblemContainer">
                  ...
                  <div>
                    ...
                    Lululiv is a startup company which needs to convey their offering to a wider audience.
                    There was no way for selling Principals to sign up or even enquire about the offering.
                    </p>
                  </div>
                </div>
                <div className="processProblemContainer">
                  ...
                  <div>
                    <p className="f-secondary">
                    The creative process was a rapid iterative approach which was over in three days.
                    </p>
                    <p className="f-secondary">
                    The website needed to convert selling Principals to enquire about this offering.
                    User feedback was crucial as the content on the website needed to be attractive to them.
                    While this was a quick turn around, it has hit all the key metrics the CEOs required.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <SectionContainer className="ak--container pb-0">
        <LeftColumn>
          <StickyContainer>
            ...
            <div className="ak--container bg-grey ctaContainer pleft-4 pright-4">
              <div className="processProblemContainerOuter">
                <div className="processProblemContainer mb-16">
                  ...
                  <div>
                    <h6 className="mb-12 f-bold leadUpper">Conversions</h6>
                  </div>
                  <div>
                    <p className="f-secondary">
                    <strong>22</strong> New Real Estate Principal enquiries
                    </p>
                  </div>
                </div>
                <div className="processProblemContainer mb-16">
                  ...
                  <div>
                    <p className="f-secondary">
                      <strong>2:37</strong> Avg. Session Duration
                    </p>
                  </div>
                </div>
                </div>
                ...
                <div className="processProblemContainer">
                  ...
                  <div>
                    <p className="f-secondary">
                    <strong>4.27</strong> Pages seen per session
                    </p>
                  </div>
                </div>
