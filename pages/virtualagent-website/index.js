            ...
            <header className="d-flex flex-row h-100">
              <div className="ak--container d-flex align-items-center justify-content-center flex-column w-50">
                <div className="header-subpage-main-text">
                  ...
                  Create a presence for Virtual Agent and it's offering of SaaS products to Real Estate agencies around Australia
                  </p>
              ...
              <div className="d-flex position-relative align-items-center justify-content-center w-50 ak--profile-image">
                <img src="./static/va-website-header.jpg" className="w-100" />
              ...
              <div className="processProblemContainerOuter">
                <div className="processProblemContainer">
                  ...
                  <div>
                    ...
                    Virtual Agent supplies software for a niche markets and needed to convey a message
                    which would convert customers into onboarding to our software.
                    </p>
                  </div>
                </div>
                <div className="processProblemContainer">
                  ...
                  <div>
                    ...
                    <p className="f-secondary">
                    The outcome was to drive enquiries for demos of the software then converting the customers
                    afterwards.
                    </p>
                  </div>
                </div>
            ...
            <div className="ak--container bg-grey ctaContainer pleft-4 pright-4">
              <div className="processProblemContainerOuter">
                <div className="processProblemContainer mb-16">
                  ...
                  <div>
                    <p className="f-secondary">
                    <strong>49.5%</strong> First interaction to the product page
                    </p>
                  </div>
                </div>
                <div className="processProblemContainer mb-16">
                  ...
                  <div>
                    <p className="f-secondary">
                      <strong>1:40</strong> Avg. Session Duration
                    </p>
                  </div>
                </div>
                </div>
                ...
                <div className="processProblemContainer">
                  ...
                  <div>
                    <p className="f-secondary">
                    <strong>1.93</strong> Pages seen per session
                    </p>
                  </div>
                </div>
