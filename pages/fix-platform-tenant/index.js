          ...
          <Col xs={12} className="h-100">
            <header className="d-flex flex-row h-100">
              ...
              <div className="d-flex position-relative align-items-center justify-content-center w-50 ak--profile-image">
                <img src="./static/tenant-fix-header.jpg" className="w-100" />
              ...
              <div className="processProblemContainerOuter">
                <div className="processProblemContainer">
                  ...
                  <div>
                    ...
                    Tenants have a difficult time letting their property managers know if there is maintenance
                    needed at their home, they need to contact through traditional means (email and call).
                    </p>
                    <p className="f-secondary">
                    This may lead to misinterpretation of the issue which leads to back and forward communication.
                    </p>
                  </div>
                </div>
                <div className="processProblemContainer">
                  ...
                  <div>
                    <p className="f-secondary">
                    Understanding the tenants frustration, the ideas started to flow. After user research and
                    empathising with tenants, the solution became clearer.
                    </p>
                    <p className="f-secondary">Creating a platform where they can
                    add, track, manage and receive updates on their maintenance requests.</p>
                  </div>
                </div>
              </div>
            ...
            <div className="ak--container bg-grey ctaContainer pleft-4 pright-4">
              <div className="processProblemContainerOuter">
                ...
                <div className="processProblemContainer">
                  ...
                  <div>
                    <p className="f-secondary">
                    <strong>Avg. two minutes per request</strong>, saved hours of back and forward emails
                    </p>
                  </div>
                </div>
